            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                {session.status === 'submitted' && (
                  <Link
                    href={`/admin/onboarding/sessions/${session.id}/report`}
                    className="px-3 py-2 text-sm font-medium bg-[#0F1A14] text-white hover:bg-[#1A2A1F] rounded-lg transition-colors flex items-center gap-1.5"
                  >
